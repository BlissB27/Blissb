        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium text-brand-brown text-center md:text-left">
              ...
              <span className="hidden md:inline">Best of Georgia 2025 &middot; Top 5 Dessert Wars 2023</span>
              <span className="block md:hidden">Top 5 Dessert Wars 2023</span>
            </span>
          </motion.div>
          ...
          >
            Cookies, cakes, and desserts crafted to turn any gathering into something guests remember.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
